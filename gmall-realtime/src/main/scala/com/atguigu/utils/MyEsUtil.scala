...
import collection.JavaConversions._//将java的集合和scala的集合进行隐式转换

object MyEsUtil {

  private val ES_HOST = "http://hadoop107"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val index: Index = new Index.Builder(Stud("zhang3", "zhang33")).index("gmall2020_stud").`type`("_doc").id("stu123").build()
    jest.execute(index)
  }
